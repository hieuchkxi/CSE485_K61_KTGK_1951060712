        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="process-them.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Tên người hiến máu</label>
                        <input name="lastname" type="text" class="form-control" id="exampleInputName">
                        <small id="emailHelp" class="form-text text-muted">Mời nhập họ</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInput">Giới Tính</label>
                        <input name="gender" type="text" class="form-control" id="exampleInput">
                    </div>
                    <div class="form-group">
                        <label for="exampleInput">Số điện thoại</label>
                        <input name="mobie" type="text" class="form-control" id="exampleInput">
                    </div>
                    <div class="form-group">
